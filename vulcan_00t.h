...
public:
  ...
  enum compression_style_t { COMPRESSION_STYLE_LZF = 4 };

  vulcan_00t_t(kaitai::kstream *p__io, kaitai::kstruct *p__parent = nullptr,
               vulcan_00t_t *p__root = nullptr);
...
public:
  ...
  public:
    level1_pointer_t(uint64_t p_index, kaitai::kstream *p__io,
                     vulcan_00t_t::level0_pointer_t *p__parent = nullptr,
                     vulcan_00t_t *p__root = nullptr);
  ...
  public:
    root_t(kaitai::kstream *p__io, kaitai::kstruct *p__parent = nullptr,
           vulcan_00t_t *p__root = nullptr);
  ...
  public:
    page_t(uint64_t p_page_index, kaitai::kstream *p__io,
           vulcan_00t_t::level3_pointer_t *p__parent = nullptr,
           vulcan_00t_t *p__root = nullptr);
  ...
  public:
    other_roots_t(kaitai::kstream *p__io, vulcan_00t_t *p__parent = nullptr,
                  vulcan_00t_t *p__root = nullptr);
  ...
  public:
    ...
    std::vector<std::unique_ptr<root_t>> *other_roots() const {
      return m_other_roots.get();
    }
    vulcan_00t_t *_root() const { return m__root; }
  ...
  public:
    level0_pointer_t(uint64_t p_index, kaitai::kstream *p__io,
                     vulcan_00t_t::root_t *p__parent = nullptr,
                     vulcan_00t_t *p__root = nullptr);
  ...
  public:
    level2_pointer_t(uint64_t p_index, kaitai::kstream *p__io,
                     vulcan_00t_t::level1_pointer_t *p__parent = nullptr,
                     vulcan_00t_t *p__root = nullptr);
  ...
  public:
    level3_pointer_t(uint64_t p_index, kaitai::kstream *p__io,
                     vulcan_00t_t::level2_pointer_t *p__parent = nullptr,
                     vulcan_00t_t *p__root = nullptr);
...
public:
  bool _is_null_other_roots() {
    other_roots();
    return n_other_roots;
  };
